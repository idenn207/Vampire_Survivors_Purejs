 ...
 * @module Data/Weapons/CoreEvolved/Blood/BloodLord
 */
(function (Data) {
  'use strict';
  ...
  Data.CoreEvolvedRegistry.blood_lord = {
    id: 'blood_lord',
    name: 'Blood Lord',
    ...
    upgrades: {
      ...
      3: { damage: 78, arc: 220, specialAbility: { bloodExplosion: { explosionRadius: 100, explosionDamage: 55 } } },
      4: { damage: 98, cooldown: 0.65, range: 180 },
