...
(function (Data) {
  ...
  var EVOLUTION_CHAIN_METADATA = {
    ...
    // Material Uncommon Weapons (Tier 2, non-core) - Used as materials for higher tier evolutions
    bifrost_bolt: { coreId: null, baseWeaponId: 'ice_shard', evolutionChain: null, isCore: false },
    homing_missile: { coreId: null, baseWeaponId: 'ember_bolt', evolutionChain: null, isCore: false },
    ricochet_shot: { coreId: null, baseWeaponId: 'stone_throw', evolutionChain: null, isCore: false },
    split_arrow: { coreId: null, baseWeaponId: 'spectral_arrow', evolutionChain: null, isCore: false },
    plasma_orb: { coreId: null, baseWeaponId: 'spark_chain', evolutionChain: null, isCore: false },
    chakram: { coreId: null, baseWeaponId: 'rusty_blade', evolutionChain: null, isCore: false },
    void_bullet: { coreId: null, baseWeaponId: 'shadow_beam', evolutionChain: null, isCore: false },
    crystal_lance: { coreId: null, baseWeaponId: 'ice_shard', evolutionChain: null, isCore: false },
    phantom_blade: { coreId: null, baseWeaponId: 'shadow_pool', evolutionChain: null, isCore: false },
    flame_scythe: { coreId: null, baseWeaponId: 'ember_field', evolutionChain: null, isCore: false },
    thunder_hammer: { coreId: null, baseWeaponId: 'battle_axe', evolutionChain: null, isCore: false },
    blood_razor: { coreId: null, baseWeaponId: 'claw_strike', evolutionChain: null, isCore: false },
    crescent_moon: { coreId: null, baseWeaponId: 'spectral_arrow', evolutionChain: null, isCore: false },
    toxic_spores: { coreId: null, baseWeaponId: 'poison_puddle', evolutionChain: null, isCore: false },
    gravity_well: { coreId: null, baseWeaponId: 'orbiting_stones', evolutionChain: null, isCore: false },
    hallowed_ring: { coreId: null, baseWeaponId: 'holy_ground', evolutionChain: null, isCore: false },
    meteor_crater: { coreId: null, baseWeaponId: 'stone_throw', evolutionChain: null, isCore: false },
    blizzard_zone: { coreId: null, baseWeaponId: 'frost_circle', evolutionChain: null, isCore: false },
    soul_orbit: { coreId: null, baseWeaponId: 'spirit_wisps', evolutionChain: null, isCore: false },
    arc_lightning: { coreId: null, baseWeaponId: 'spark_chain', evolutionChain: null, isCore: false },
    blade_vortex: { coreId: null, baseWeaponId: 'rusty_blade', evolutionChain: null, isCore: false },
    toxic_chain: { coreId: null, baseWeaponId: 'venom_fang', evolutionChain: null, isCore: false },
    flame_dancers: { coreId: null, baseWeaponId: 'fire_sprite', evolutionChain: null, isCore: false },
    cluster_mine: { coreId: null, baseWeaponId: 'spike_trap', evolutionChain: null, isCore: false },
    magnetic_mine: { coreId: null, baseWeaponId: 'spike_trap', evolutionChain: null, isCore: false },
    chain_reaction_mine: { coreId: null, baseWeaponId: 'spike_trap', evolutionChain: null, isCore: false },
    prismatic_ray: { coreId: null, baseWeaponId: 'light_ray', evolutionChain: null, isCore: false },
    piercing_gaze: { coreId: null, baseWeaponId: 'light_ray', evolutionChain: null, isCore: false },
    shadow_clone: { coreId: null, baseWeaponId: 'shadow_pool', evolutionChain: null, isCore: false },
    frost_elemental: { coreId: null, baseWeaponId: 'ice_bomb', evolutionChain: null, isCore: false },
  ...
  var EVOLUTION_RECIPES = {
    ...
    // T1 common + T1 common → T2 uncommon (used as materials in higher tier recipes)
    // ============================================
    'ice_shard+light_ray': { result: 'bifrost_bolt', resultTier: 2, isKnown: true },
    'ember_bolt+wind_cutter': { result: 'homing_missile', resultTier: 2, isKnown: true },
    'stone_throw+scatter_shot': { result: 'ricochet_shot', resultTier: 2, isKnown: true },
    'spectral_arrow+wind_cutter': { result: 'split_arrow', resultTier: 2, isKnown: true },
    'spark_chain+fire_motes': { result: 'plasma_orb', resultTier: 2, isKnown: true },
    'rusty_blade+orbiting_stones': { result: 'chakram', resultTier: 2, isKnown: true },
    'shadow_beam+arcane_dart': { result: 'void_bullet', resultTier: 2, isKnown: true },
    'ice_shard+stone_throw': { result: 'crystal_lance', resultTier: 2, isKnown: true },
    'shadow_pool+rusty_blade': { result: 'phantom_blade', resultTier: 2, isKnown: true },
    'ember_field+cleaver': { result: 'flame_scythe', resultTier: 2, isKnown: true },
    'battle_axe+flash_bomb': { result: 'thunder_hammer', resultTier: 2, isKnown: true },
    'claw_strike+venom_fang': { result: 'blood_razor', resultTier: 2, isKnown: true },
    'spectral_arrow+shadow_beam': { result: 'crescent_moon', resultTier: 2, isKnown: true },
    'poison_puddle+spirit_wisps': { result: 'toxic_spores', resultTier: 2, isKnown: true },
    'orbiting_stones+shadow_pool': { result: 'gravity_well', resultTier: 2, isKnown: true },
    'holy_ground+orbiting_stones': { result: 'hallowed_ring', resultTier: 2, isKnown: true },
    'stone_throw+ember_field': { result: 'meteor_crater', resultTier: 2, isKnown: true },
    'frost_circle+ice_bomb': { result: 'blizzard_zone', resultTier: 2, isKnown: true },
    'spirit_wisps+orbiting_stones': { result: 'soul_orbit', resultTier: 2, isKnown: true },
    'spark_chain+arcane_dart': { result: 'arc_lightning', resultTier: 2, isKnown: true },
    'rusty_blade+wind_cutter': { result: 'blade_vortex', resultTier: 2, isKnown: true },
    'venom_fang+spark_chain': { result: 'toxic_chain', resultTier: 2, isKnown: true },
    'fire_sprite+fire_motes': { result: 'flame_dancers', resultTier: 2, isKnown: true },
    'spike_trap+ice_bomb': { result: 'cluster_mine', resultTier: 2, isKnown: true },
    'spike_trap+orbiting_stones': { result: 'magnetic_mine', resultTier: 2, isKnown: true },
    'spike_trap+spark_chain': { result: 'chain_reaction_mine', resultTier: 2, isKnown: true },
    'light_ray+frost_circle': { result: 'prismatic_ray', resultTier: 2, isKnown: true },
